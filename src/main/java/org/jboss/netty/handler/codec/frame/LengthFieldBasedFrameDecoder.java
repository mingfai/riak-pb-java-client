...
public class LengthFieldBasedFrameDecoder extends FrameDecoder{
    static Log log = LogFactory.getLog(LengthFieldBasedFrameDecoder.class);
    ...
    protected Object decode(
        ...
        if (log.isTraceEnabled())
            log.trace("decode() - frameLength: " + frameLength + ", buffer: " + new String(Hex.encodeHex(buffer.array())));
        if (frameLength < 0){
